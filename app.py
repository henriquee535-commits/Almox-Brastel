...
# ==========================================
    ...
    if senha == SENHA_ACESSO:
        ...
        # VISUAL MELHORADO: Formulário em colunas
        with st.form("form_movimentacao", clear_on_submit=True):
            col1, col2 = st.columns(2)
            codigo = col1.text_input("Código do Item:")
            descricao = col2.text_input("Descrição (Deixe em branco se o item já existe na empresa):")
            ...
            submit = st.form_submit_button("Salvar Registro", type="primary") # type="primary" deixa o botão em destaque
        ...
        # NOVA FUNÇÃO: Excluir item duplicado/errado
        with st.expander("🗑️ Excluir ou Corrigir um Registro"):
            ...
            with st.form("form_excluir"):
                ...
                cc_ex = st.selectbox("Setor (CC):", lista_cc)
